...
BOT_TOKEN = environ.get('BOT_TOKEN', "7329027311:AAHo49AxTzSw8nuTxGFMHhgdja5Ru4Dr8ew")
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '7816883745').split()]
...
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://vasuu2412:<vasu2412>@cluster0.wiypu.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002149303924')) #Log channel id ( make sure bot is admin )
